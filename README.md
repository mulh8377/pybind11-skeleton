# building and experimenting with pybind11:
various ds/algos are implemented.

This is mostly for personal practice, but other developers may find
these examples useful.

## cloned from the following url: https://github.com/pybind/cmake_example/
